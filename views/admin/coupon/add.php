...
<div class="body d-flex py-lg-3 py-md-2">
    <div class="container-xxl">
        <form action="?act=coupon-create" method="post">
            <div class="row align-items-center">
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                        <h3 class="fw-bold mb-0">Thêm phiếu giảm giá</h3>
                    </div>
                </div>
            </div> <!-- Row end  -->
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" value="hidden" checked>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Mời nhập tên mã giảm giá">
                                    <br>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="coupon_code" placeholder="Mời nhập mã giảm giá">
                                    <br>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="quantity" placeholder="Mời nhập số lượng">
                            </div>
                            <br>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="coupon_value" placeholder="Giá trị giảm">
                            </div>
                            <br>
            ...
            <div class="col-md-3">
                <button type="submit" name="coupon-create" class="btn btn-primary mt-4 text-uppercase px-5">Submit</button>
            </div>
    </div><!-- Row End -->
    </form>
</div>
