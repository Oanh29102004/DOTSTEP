  ...
  <div class="footer-middle container">
    <div class="row row-cols-lg-5 row-cols-2">
      <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
        ...
        <p class="footer-address">Đường Trịnh Văn Bô - Phương Canh - Nam Từ Niêm - Hà Nội</p>

        <p class="m-0">
          <strong class="fw-medium">dotstep@gmail.com</strong>
        </p>
        <p>
          <strong class="fw-medium">0988669933</strong>
        </p>
      ...
      <div class="footer-column footer-menu mb-4 mb-lg-0">
        <h6 class="sub-menu__title text-uppercase">Thông tin</h6>
        <ul class="sub-menu__list list-unstyled">
          <li class="sub-menu__item"><a href="about.html" class="menu-link menu-link_us-s">Giới thiệu</a></li>
      ...
      <div class="footer-column footer-menu mb-4 mb-lg-0">
        ...
        <ul class="sub-menu__list list-unstyled">
          <li class="sub-menu__item"><a href="shop2.html" class="menu-link menu-link_us-s">Sản phẩm</a></li>
          <li class="sub-menu__item"><a href="shop3.html" class="menu-link menu-link_us-s">Danh mục</a></li>
      ...
      <div class="footer-column footer-menu mb-4 mb-lg-0">
        ...
        <ul class="sub-menu__list list-unstyled">
          ...
          <li class="sub-menu__item"><a href="account_dashboard.html" class="menu-link menu-link_us-s">Tài khoản</a></li>
          <li class="sub-menu__item"><a href="contact.html" class="menu-link menu-link_us-s">Liên hệ</a></li>
        </ul>
      </div><!-- /.footer-column -->
...
<!-- <script src="client/js/plugins/jquery.waypoints.min.js"></script> -->
<!-- <script src="client/js/plugins/sticky.min.js"></script> -->
...
<!-- Mirrored from uomo-html.flexkitux.com/Demo4/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Nov 2024 14:17:59 GMT -->
